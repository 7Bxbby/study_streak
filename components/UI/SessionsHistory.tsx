...
// }
interface Props {
    sessions: Array<{ id: number, subject: string, duration: number, date: string, technique: string }>;
}
                        ...
                        <table className="min-w-full divide-y divide-gray-700">
                            ...
                            {sessions ? (
                                sessions.slice(-8).map((session) => (
                                    <tr key={session.id} className="bg-gray-800 hover:bg-[#1a2331] transition-colors select-none duration-150">
